...
//system
Route::get('api/:version/system/store_pos', 'api/:version.System/getStorePos');
Route::get('api/:version/system/check_open', 'api/:version.System/checkOpen');
//Route::get('api/:version/system/test', 'api/:version.System/autoClose');
//Order
